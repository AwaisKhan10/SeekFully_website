      ...
      <div className="flex-1 flex flex-col justify-between">
        ...
        <div className="flex justify-center p-6">
          <input
            type="text"
            placeholder="Search"
            className="w-3/4 border-2 border-red-200 rounded-lg px-4 py-2 focus:outline-none"
          />
        </div>
        ...
        <div className="space-y-4 px-6">
          {notes.map((item, index) => (
            ...
            >
              ...
              <div className="text-xs text-black h-6 flex items-center pl-3 bg-gray-300 mt-2">
                {item.note}
              </div>
            </div>
          ))}
        ...
        <div className="flex justify-center my-10">
          <button
            className="bg-red-600 text-white px-8 py-2 rounded-full hover:bg-red-700"
