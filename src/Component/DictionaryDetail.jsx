...
const DictionaryDetail = () => {
  ...
  <Link
    to="/dictionary"
    className="flex-1 bg-yellow-500 text-white rounded-md py-6 font-semibold text-sm hover:opacity-90 transition text-center flex items-center justify-center"
  >
    Dictionary
  </Link>
