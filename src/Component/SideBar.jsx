...
const Sidebar = () => {
  return (
    <div className="w-[80px] sm:w-[100px] md:w-[120px] lg:w-[150px] h-screen bg-white shadow-md flex flex-col items-center py-6 fixed">
      ...
      <Link to="/tool">     <div className="flex flex-col items-center text-center mb-8">
    ...
    <span className="text-[10px] font-semibold text-red-600 uppercase">Create</span>
     ...
     <Link to="/study-interlinear">  <li className="flex flex-col items-center  cursor-pointer hover:scale-110 transition-transform">
          <div className="hover:bg-red-300 p-2 rounded-lg">
            <img src={color} alt="color" className="w-5 h-5" />
          </div>
          <span className="text-[10px] mt-1 text-gray-700 uppercase font-medium">VM</span>
        </li>
        </Link> 

   <Link to="/Comunity"> <li className="flex flex-col items-center  cursor-pointer hover:scale-110 transition-transform">
        <div className="hover:bg-red-300 p-2 rounded-lg">
          <img src={whatsapp} alt="Community" className="w-5 h-5" />
          </div>
  ...
  <Link to="/study-interlinear">   <li className="flex flex-col items-center cursor-pointer hover:scale-110 transition-transform">
        <div className="hover:bg-red-300 p-2 rounded-lg">
          <img src={book} alt="Bible" className="w-5 h-5" />
          </div>
      ...
      <Link to="/study">
        ...
        <div className="hover:bg-red-300 p-2 rounded-lg">
          <img src={file} alt="Study" className="w-5 h-5" />
          </div>
      ...
      <Link to="/more"> <li className="flex flex-col items-center cursor-pointer hover:scale-110 transition-transform">
        <div className="hover:bg-red-300 p-2 rounded-lg">
