      ...
      <main className="flex-1 ml-20 flex flex-col items-center px-4 py-6">
        ...
        <div className="p-6 w-full max-w-7xl">
          ...
          <div className="flex space-x-3 mb-6 select-none">
            <Link
              to="/bible-book-study"
              className="flex-1 bg-blue-600 dark:bg-blue-700 text-white rounded-md py-2 font-semibold text-sm hover:opacity-90 transition text-center flex items-center justify-center"
            >
              Bible Book Study
            </Link>
            <Link
              to="/theological-implication"
              className="flex-1 bg-yellow-600 dark:bg-yellow-700 text-white rounded-md py-6 font-semibold text-sm hover:opacity-90 transition text-center flex items-center justify-center"
            >
              Theological Implication
            </Link>
            <Link
              to="/jeremiah"
              className="flex-1 bg-red-500 dark:bg-red-600 text-white rounded-md py-2 font-semibold text-sm hover:opacity-90 transition text-center flex items-center justify-center"
            >
              Interlinear
            </Link>
          </div>
