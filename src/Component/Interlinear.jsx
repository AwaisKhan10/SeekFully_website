  ...
  <div className="flex flex-col md:flex-row bg-gray-100 dark:bg-gray-900 min-h-screen font-montserrat transition-colors duration-300">
      ...
      <main className="flex-1  sm:p-6 md:pt-3">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-8 max-w-6xl mx-auto transition-colors duration-300">
          ...
          {/* Filters */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-3 sm:space-y-0 mb-6 ms-4">
          <div
              className="flex w-[560px] rounded-lg border border-red-300 overflow-hidden"
              style={{ height: "46px" }}
            >
            ...
            <Menu as="div" className="relative">
              <Menu.Button className="flex items-center justify-between w-30 border border-gray-200 dark:border-gray-400 bg-white dark:bg-gray-800 rounded-md px-3 py-2 text-sm text-gray-600 dark:text-gray-200 focus:outline-none focus:ring-1 focus:ring-red-300 dark:focus:ring-red-700">
                Index
            ...
            {/* Chapter Dropdown */}
            <Menu as="div" className="relative">
              <Menu.Button className="flex items-center justify-between w-30 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-md px-3 py-2 text-sm text-gray-600 dark:text-gray-200 focus:outline-none focus:ring-1 focus:ring-red-300 dark:focus:ring-red-700">
                Chapter
                <ChevronDownIcon className="w-4 h-4 ml-2" />
              </Menu.Button>
