      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-gray-300 bg-[#e6ecec] sticky top-0 z-20">
        ...
        <div className="flex-1 flex justify-center mt-4">
          <div className="flex items-center space-x-2 bg-white border border-gray-300 rounded-lg px-3 py-1 shadow-sm max-w-full overflow-x-auto">
            ...
            />
            <button className="text-gray-700 font-semibold text-lg px-3 py-1 rounded-md border border-gray-300 hover:bg-gray-100">
              −
            </button>
            ...
            <button
              className="text-gray-900 text-lg font-bold px-2"
              title="Bold"
            >
              B
            </button>
            <button
              className="text-gray-900 text-lg italic px-2"
              title="Italic"
            >
              I
            </button>
            <button
              className="text-gray-900 text-lg underline px-2"
              title="Underline"
            >
              U
            </button>
            <button
              className="text-gray-900 text-lg line-through px-2"
              title="Strikethrough"
            >
              S
            </button>
            <button
              className="text-gray-900 text-sm font-semibold px-2"
              title="Font size"
            >
              aA
            </button>
            <button className="text-gray-900 text-lg px-2" title="Align left">
              <i className="fas fa-align-left"></i>
            </button>
            <button
              className="text-gray-900 text-lg px-2"
              title="Align justify"
            >
            ...
            <button className="text-gray-900 text-lg px-2" title="List ordered">
