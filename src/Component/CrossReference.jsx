      ...
      <main className="flex-1 md:ml-13 p-4 sm:p-6 pt-24 sm:pt-6 w-full">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-8 max-w-6xl mx-auto transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 select-none">
            ...
            <Link
              to="/sermon-mount"
              className="bg-[#D9A79E] text-white rounded-md h-20 font-semibold text-sm hover:opacity-90 transition flex items-center justify-center text-center"
            >
              Cross Reference
            </Link>
            <Link
              to="/cross-reference"
              className="bg-[#B33A36]  text-white rounded-md h-16 font-semibold text-sm hover:opacity-90 transition flex items-center justify-center text-center"
            >
              Interlinear
            </Link>
          </div>
