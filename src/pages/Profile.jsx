...
function Profile() {
  ...
  // 👇 Ensure <html> gets updated if theme changes (for safety)
  useEffect(() => {
  ...
  return (
    <>
      <div className="flex">
        ...
        <div className="bg-gradient-to-t from-white to-gray-200 dark:from-gray-900 dark:to-gray-700 min-h-screen p-6 shadow-lg w-screen">
          {/* Sidebar */}
          ...
          <main className="flex-1 p-6">
            <div className="max-w-4xl mx-auto">
              {/* Profile Header */}
              <div className="flex flex-col items-center p-6 rounded-2xl  dark:bg-gray-900 ">
                <img
                  src={profilepage}
                  alt="Profile"
